...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-serif font-bold tracking-tighter leading-none mb-8 text-balance">
            {t('hero.heading')} <br />
            <span className="italic font-light opacity-80">{t('hero.subheading')}</span>
          </h1>
      ...
      >
        <span className="text-[10px] tracking-[0.2em] text-brand-muted uppercase">{t('hero.scroll')}</span>
